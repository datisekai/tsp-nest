...
export enum AppPermission {
  ...
  SCORE_COLUMN_VIEW = 'score_column:view',
  SCORE_COLUMN_DELETE = 'score_column:delete',
  SCORE_COLUMN_UPDATE = 'score_column:update',
  STUDENT_SCORE_UPDATE = 'student_score:update',
